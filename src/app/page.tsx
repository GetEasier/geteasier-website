            ...
            <div className="space-y-6 md:space-y-8 text-center lg:text-left">
              ...
              <AnimationFadeUp delay={0.4} duration={0.6} once>
                <div className="flex items-center justify-center lg:justify-start gap-2.5 pt-1">
                  {/* App Store */}
                  <a
                    href="https://apps.apple.com/pt/app/timeeasier/id6755851894"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gray-900 hover:bg-gray-800 active:bg-black transition-colors duration-200 shadow-sm hover:shadow-md min-w-0"
                  >
                    ...
                    <div className="text-left">
                      <div className="text-[9px] text-gray-400 leading-none">Disponível na</div>
                  ...
                  {/* Google Play */}
                  <a
                    href="https://play.google.com/store/apps/details?id=com.geteasier.timeeasier&hl=pt_PT"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gray-900 hover:bg-gray-800 active:bg-black transition-colors duration-200 shadow-sm hover:shadow-md min-w-0"
                  >
                    <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none">
                      <path d="M3.18 23.76c.3.17.64.24.99.2L14.64 12 3.18.04A1.5 1.5 0 002 1.5v21c0 .5.27.97.7 1.26h.01l.47-.0z" fill="#EA4335"/>
                      <path d="M22.04 10.56l-3.1-1.77-3.5 3.21 3.5 3.22 3.13-1.79a1.5 1.5 0 000-2.87z" fill="#FBBC04"/>
                      <path d="M3.18.04L14.64 12 18.94 7.7 5.17.08A1.5 1.5 0 003.18.04z" fill="#4285F4"/>
                      <path d="M3.18 23.76a1.5 1.5 0 001.99-.08l13.77-7.63-4.3-4.3L3.18 23.76z" fill="#34A853"/>
                    </svg>
                    <div className="text-left">
                      <div className="text-[9px] text-gray-400 leading-none">Disponível no</div>
